...
import egovframework.com.cmm.SignUpRequest;
...
public class EgovLoginApiController {
	...
	/**
	 * 회원가입 처리
	 * @param vo - 아이디, 비밀번호가 담긴 SignUpRequest
	 * @exception Exception
	 */
	@PostMapping(value ="/uat/uia/actionSignUpAPI.do")
	public ResponseEntity<String> sampleSignUp(@RequestBody SignUpRequest signUpRequest) {
	    try {	        
